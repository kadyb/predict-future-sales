...
holidays = data.table(date_block_num = seq(0, 35), holidays = c(10, 5, 6, 4, 9, 6, 4, 4, 5, 4, 5, 5, 10, 5, 7, 4, 9, 8, 4, 5, 4, 4, 8, 4, 12, 5, 6, 4, 9, 5, 4, 5, 4, 4, 6, 4))
```
...
exchange = data.table(date_block_num = seq(0, 35), exchange = c(30.244, 30.180, 30.817, 31.347, 31.326, 32.309, 32.769, 32.992, 32.601, 32.077, 32.688, 32.868, 33.676, 35.245, 36.195, 35.659, 34.918, 34.392, 34.685, 36.144, 37.951, 40.815, 46.257, 55.967, 63.678, 64.443, 60.262, 53.179, 50.683, 54.611, 57.156, 65.355, 66.950, 63.126, 65.083, 69.897))
```
...
# TODO
0. na pewno uzyc xgboost i ranger
...
4. obliczyc iloczyn sprzedanych przedmiotow i ich ceny
6. pamietac zeby przyciac wartosci do zakresu 0-20 (wieksza niz 20 staja sie 20)
// nie dodawac liczby dni w miesiecu ani dni gieldowych
